...
tmux new-window -t audiov1:3 -n 'ctranslate2' "bash -c 'export CUDA_VISIBLE_DEVICES=1; cd ~/repos/meditation-sample-demo ; conda activate pytorch2.1 ; export KMP_DUPLICATE_LIB_OK=TRUE; export LD_LIBRARY_PATH=$LD_LIBRARY_PATH:/opt/ctranslate2/lib; python ct2_llama2.py' "
